...
const checkAuth = (...authRoles) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!accessToken) {
            throw new AppError_1.default(http_status_codes_1.default.NOT_FOUND, "Access Token Not Received Yet!");
        }
        ...
        if (!authRoles.includes(verifiedToken.role)) {
            throw new AppError_1.default(http_status_codes_1.default.FORBIDDEN, "You are not permitted to view this route data!");
        }
