...
const createUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isUserExist) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "User Already Exist, try with another email!");
    }
...
const getMe = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    let isUserExist = yield user_model_1.User.findById(userId);
    if (!isUserExist) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "User Not Found!");
    }
    isUserExist = yield user_model_1.User.findById(userId).select("-password");
    return {
        data: isUserExist
    };
});
